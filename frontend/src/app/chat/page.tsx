...
export default function Home() {
    ...
    useEffect(() => {
        scrollToBottom()
    }, [messages, currentTools, openStates, currentToolsOpen, typingMessage])
    ...
    const callChatAPI = async (userMessage: string) => {
        ...
        try {
            ...
            const response = await fetch(`${env.NEXT_PUBLIC_SERVER_URL}/api/v0/agent/chat`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${env.NEXT_PUBLIC_SERVER_API_KEY}`
                },
